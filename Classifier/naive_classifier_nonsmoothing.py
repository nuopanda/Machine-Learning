...
def main():
    ...
    calculateLogProb(spam_words_dict, spam_words_count)
    calculateLogProb(ham_words_dict, ham_words_count)
#     for i in spam_words.keys():
#         print(i, spam_words[i])
    ...
    result, spam_list = getTestResult(test_directory, spam_words_dict, ham_words_dict, log_prob_spam, log_prob_ham)
    print(spam_list)
    #calculate precision
...
def calculateLogProb(dict, count):
    for i in dict.keys():
        prob = dict[i] /count
